...
const PATH = "https://localhost/mediashared/src/user-apis/userinfo.php";
const NEWPROPIC = "https://localhost/mediashared/src/user-apis/upload.php";
const CHANGEIMG = "https://localhost/mediashared/src/user-apis/newprofileimg.php";
const CHANGEINFO = "https://localhost/mediashared/src/user-apis/newprofileinfo.php";
...
function Profile({user}) {
  ...
  useEffect(() => {
    ...
    .then((result) => {
      const imgAlter = "https://localhost/mediashared/src/user-apis/" + result.data.img
  ...
  useEffect(() => {
    ...
    const imgAlter = "https://localhost/mediashared/src/user-apis/" + inputs.imgpath;
